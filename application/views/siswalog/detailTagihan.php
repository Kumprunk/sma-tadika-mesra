    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="<?= base_url('siswalog/tagihan/' . $tagihan['nis']); ?>">Daftar Tagihan</a></div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" style="text-transform: uppercase;" readonly value="<?= $tagihan['bank']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" style="text-transform: capitalize; font-style: italic;" readonly value="<?= $tagihan['penerima']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="card-footer bg-whitesmoke"></div>
