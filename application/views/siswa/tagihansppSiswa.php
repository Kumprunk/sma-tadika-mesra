<div class="section-body">
    ...
    <p class="section-lead">Daftar tagihan spp bulanan siswa <b style="text-transform: uppercase;"><?= $siswa['nis'] . ' - ' . $siswa['nama']; ?></b> </p>

    <div class="card shadow">
        <div class="card-header">
            <a href="#" class="btn btn-outline-primary mr-1 mb-1"><i class="fas fa-plus"></i> Tambah</a>
            <a href="#" class="btn btn-outline-primary mr-1 mb-1"><i class="fas fa-print"></i> Cetak</a>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        foreach ($tagihan_res as $tagihan) : ?>
                            <tr>
                                ...
                                <td><a href="<?= base_url('siswa/detailTagihan/' . $tagihan['id']); ?>"><?= strftime('%B %Y', strtotime($tagihan['bulan'])); ?></a></td>
                                ...
                                <td>
                                    ...
                                    <?php elseif ($tagihan['status_kode'] == 0) : ?>
                                        <div class="dropdown">
                                            <span class="badge badge-secondary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">[0] Bayar sekarang</span>
                                            <div class="dropdown-menu shadow">
                                                <a class="dropdown-item" href="<?= base_url('siswa/bayarCash/' . $tagihan['id']); ?>">Cash / Tunai</a>
                                                <a class="dropdown-item" href="#">Transfer / Dompet Digital</a>
                                            </div>
                                        </div>
                                    <?php else : ?>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu shadow">
                                            <a href="<?= base_url('siswa/detailTagihan/' . $tagihan['id']); ?>" class="dropdown-item has-icon "><i class="fas fa-eye"></i> Detail Tagihan</a>
                                            <?php if ($tagihan['status_kode'] == 201) : ?>
                                                <a href="#" class="dropdown-item has-icon "><i class="fas fa-download"></i> Panduan Pembayaran</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
